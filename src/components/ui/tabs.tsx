...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center gap-1 rounded-xl border border-border bg-muted p-1 text-muted-foreground app-shell-tabs-list",
      className,
    )}
    {...props}
  />
