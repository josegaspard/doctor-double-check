...
const badgeVariants = cva(
  // whitespace-nowrap previene que Badge se rompa en 2 líneas (forma ovalada
  // fea) cuando el contenedor padre es estrecho — siempre debe ser pill 1-line.
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 whitespace-nowrap",
  {
    variants: {
      variant: {
        ...
        live: "border-transparent bg-live text-live-foreground animate-pulse-live",
