...
function AppStoreBadges({ className = '' }: { className?: string }) {
  return (
    <div className={`flex flex-wrap gap-3 items-center ${className}`}>
      {/* Apple App Store — Official style */}
      <a
        href="#"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg bg-black border border-white/20 hover:bg-black/80 transition-colors"
      >
        ...
        <div className="flex flex-col leading-none">
          <span className="text-[8px] sm:text-[9px] text-white/70">Disponible en</span>
