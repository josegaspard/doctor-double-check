  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 max-w-6xl">
        <Button variant="back" size="sm" onClick={() => navigate('/recordings')} className="hidden sm:inline-flex mb-3 sm:mb-4 h-8 text-xs sm:text-sm hover:bg-transparent hover:text-foreground">
