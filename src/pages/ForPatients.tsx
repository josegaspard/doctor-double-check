    ...
    <div className="font-sans text-slate-800 bg-slate-50 min-h-screen selection:bg-[#00768b] selection:text-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-6">
              <Heart className="w-4 h-4 text-[#aed3d9]" />
              <span className="text-xs font-bold uppercase tracking-widest text-[#aed3d9]">Para Pacientes</span>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 max-w-4xl mx-auto">
            {howItWorks.map((item) => (
              <div key={item.step} className="text-center">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-[#163a83] to-[#00768b] flex items-center justify-center mx-auto mb-4 text-white text-xl sm:text-2xl font-bold">
                  {item.step}
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
                <Users className="w-12 h-12 text-[#163a83] mb-4" />
                <h3 className="text-2xl font-bold text-gray-800 mb-3">+5,000 Médicos</h3>
              ...
              <div>
                ...
                <Link 
                  to="/doctors" 
                  className="inline-flex items-center text-[#00768b] font-semibold hover:underline"
                >
                  Explorar médicos →
                </Link>
              </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-[#163a83] to-[#00768b]">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Cuida tu salud hoy</h2>
