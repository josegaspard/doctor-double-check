  ...
  return (
    <MainLayout>
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-primary/[0.02] via-secondary/[0.01] to-primary/[0.02]">
        {/* Decorative medical-style background — mix of large soft circles + rings + small dots */}
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
          {/* Large soft filled circles */}
          <div className="absolute -top-10 -left-16 w-80 h-80 sm:w-[28rem] sm:h-[28rem] rounded-full bg-primary/[0.05]" />
          <div className="absolute top-48 right-0 w-64 h-64 sm:w-96 sm:h-96 rounded-full bg-primary/[0.04]" />
          <div className="absolute top-[30rem] left-[10%] w-72 h-72 sm:w-[22rem] sm:h-[22rem] rounded-full bg-secondary/[0.04]" />
          <div className="absolute top-[55rem] right-[15%] w-56 h-56 sm:w-80 sm:h-80 rounded-full bg-primary/[0.03]" />
          <div className="absolute bottom-40 -left-10 w-60 h-60 sm:w-[20rem] sm:h-[20rem] rounded-full bg-primary/[0.04]" />
          <div className="absolute bottom-10 right-[5%] w-48 h-48 sm:w-72 sm:h-72 rounded-full bg-secondary/[0.03]" />

          {/* Ring-style circles for "design" feel */}
          ...
          <div className="absolute top-[50rem] left-[20%] w-32 h-32 sm:w-48 sm:h-48 rounded-full border border-primary/[0.06]" />
